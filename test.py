...
style_image = Variable(transform(Image.open(opts.style).convert('RGB')).unsqueeze(0), volatile=True) if opts.style != '' else None
...
# Start testing
style_rand = Variable(torch.randn(opts.num_style, style_dim, 1, 1))
